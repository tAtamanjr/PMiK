...
void drawMiddleHorizontal(const coordinate_e x, const coordinate_e y) {
    ...
    display.fillRectangle(19 + x * 11, 19 + y * 11 + 2, 10, 6, WOOD_BOAT);
}

void drawMiddleVertical(const coordinate_e x, const coordinate_e y) {
    display.fillRectangle(19 + x * 11, 19 + y * 11, 10, 10, WATER);

    display.fillRectangle(19 + x * 11 + 2, 19 + y * 11, 6, 10, WOOD_BOAT);
}

void drawEndVertical(const coordinate_e x, const coordinate_e y) {
    display.fillRectangle(19 + x * 11, 19 + y * 11, 10, 10, WATER);

    display.fillRectangle(19 + 2 + x * 11, 19 + y * 11, 6, 10, WOOD_BOAT);
    display.drawHorizontalLine(19 + 4 + x * 11, 19 + 8 + y * 11, 2, 1, WATER);
    display.drawHorizontalLine(19 + 3 + x * 11, 19 + 9 + y * 11, 4, 1, WATER);
}
...
void drawEndHorizontal(const coordinate_e x, const coordinate_e y) {
    ...
    display.fillRectangle(19 + x * 11, 19 + 2 + y * 11, 10, 6, WOOD_BOAT);
    display.drawVerticalLine(19 + 8 + x * 11, 19 + 4 + y * 11, 2, 1, WATER);
    display.drawVerticalLine(19 + 9 + x * 11, 19 + 3 + y * 11, 4, 1, WATER);
}
